...
namespace PlanIVent
{
    ...
    public partial class EvPlannerEntities : DbContext
    {
        public EvPlannerEntities()
            : base("name=EvPlannerEntities")
        {
        }
        ...
        public virtual DbSet<Categorii_Personal> Categorii_Personal { get; set; }
        ...
        public virtual DbSet<Status_Ev> Status_Ev { get; set; }
